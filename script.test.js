...
const fibonacciRecurse = require("./fibonacciRecurse");

test("number less than (or equal to) 0", () => {
  expect(fibonacciRecurse(-3)).toBe(0);
  expect(fibonacciRecurse(0)).toBe(0);
});

test("number = 1", () => {
  expect(fibonacciRecurse(1)).toBe(1);
});

test("number = 2", () => {
  expect(fibonacciRecurse(2)).toBe(1);
});

test("number greater than 1", () => {
  expect(fibonacciRecurse(4)).toBe(3);
  expect(fibonacciRecurse(6)).toBe(8);
});
